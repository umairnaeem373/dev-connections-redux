...
function AddEducation() {
  ...
  useEffect(()=>{
    ...
    const handleSubmit=()=>{
        const {feild,degree,school,date}=Inp
        if(!school || !feild || !degree || !date){
        alert('Please fill all fields!')
        }
        else {
        user.education?
        dispatch(editProfile(user.id,{education:[...user.education,Inp]})):
        dispatch(editProfile(user.id,{education:[Inp]}))
    }
    }
